...
%token REGISTER AUTO CASE DEFAULT IF ELSE SWITCH WHILE DO FOR GOTO CONTINUE BREAK RETURN 
%token ENUM TYPEDEF EXTERN STATIC INLINE 
%token SIGNED UNSIGNED CHAR SHORT INT LONG DOUBLE CONST VOLATILE VOID FLOAT 
%token RESTRICT UNION SIZEOF STRUCT BOOL COMPLEX IMAGINARY
