//test file to check basic statements, expression, readInt and printInt library functions created in assignment 2
...
int main () {
  ...
  printStr("\n RECURSIVE FIBONACCI SIMULATION [ TEST FUNCTION CALLS AND LIBRARY MYL.H ]\n");
